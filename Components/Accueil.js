...
class Accueil extends React.Component {
	...
	/*_displayDetailForMonument = (idMonument) => {
    console.log("Display Monument with id " + idMonument)
	...
	render() {
      ...
      vote_average:7.2,
      title:"Tour EIFFEL",
      poster_path:"../assets/images/Tour_Eiffel.jpg",
      original_title:"",
   ...
   },
   {
      ...
      poster_path:"",
      original_title:"../assets/images/Arc_de_Triomphe.jpg",
	...
	renderItem={({item}) => <MonumentItem monument={item} displayDetailForMonument={this._displayDetailForMonument}/>}
	/>
